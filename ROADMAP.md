...
| Pathfinder 2e (Remaster) system support | 2 | 3 | XL (4) | 1.8 | In progress | Add `systems/pf2e/` to ttrpg-expert on the D&D model (core five + index/shard fan-outs), routing, PC template, publish renderer, ORC ATTRIBUTION entry. Source corpus acquired 2026-07-08: ORC-licensed Remaster mirror at `~/PROJECTS/reference-srds/pf2e-orc/md/` (2,128 pages — 8 PC1 classes w/ full progressions, 22 ancestries, 886 feats, 583 monsters, GM tables; spells inline in magic.md need splitting; no Player Core 2 classes yet). Legacy CUP vault clone stays personal-reference only. |
