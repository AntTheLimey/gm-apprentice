...
| ~~Session-prep: GM approval gate for new scenes~~ | 5 | 4 | S (1) | 14.0 | Done | When session-prep creates new scenes, it must present each to the GM first with framing questions (tone, objective, key entities, scene type) before writing. GM controls what goes into their session, not the skill. |
