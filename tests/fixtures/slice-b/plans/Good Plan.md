...
<!-- prep-state: intent=set spotlight=Ada(B) scenes=2of2 open=[] -->

## Session Intent

This one's Ada's — the Congress ball forces her into the Brotherhood's
orbit for the first time, and I want the stakes of high society to feel
real without a fight breaking out.

## Session Overview

The investigators attend the Congress of Vienna's grand ball, where Ada
makes first contact with the Brotherhood's inner circle while the rest of
the party works the edges of the room.

## GM Notes

Keeper only: the Brotherhood's inner circle already knows Ada attended
last winter's salon in Prague. Tonight is their first chance to learn
whether she remembers the courier who never came back. No prior reconcile
to summarise — this is the chapter's first session.

## Prior Prep Review

No prior plan exists for this chapter yet, so there is nothing to carry
forward or update this week.
...
|-----|-------------------|------------|----------|
| [[Bruyère]] | Introduces Ada to the inner circle | Speaks of France as though it still exists | Hofburg ballroom |
| [[Sternberg]] | Watches the doors for the Brotherhood | Never removes his gloves | Hofburg entrance hall |
...
- Ada either confirms or denies recognising the courier to Bruyère,
  moving the Brotherhood's trust one way or the other.
- Marlowe gets a look inside the locked store room, even if she can't
  fully search it tonight.
- At minimum, the party leaves the ball without the Brotherhood
  suspecting them of anything.
...
No structural gaps found — Sternberg's file still needs promotion from
DRAFT once tonight's scene confirms his allegiance, but that's expected
rather than urgent.
