# Character Sheet — Dr. Helena Voss

*Transcribed from printed sheet, current as of session 2*
...
**Age:** 34
**Residence:** Boston, MA (currently staying at the Kingsport Arms)
**Birthplace:** Leipzig, Germany (emigrated 1910)
...
*Note: Luck was 40 at start of campaign — hasn't updated this*
...
| Stealth            | 20   | 25    |
| Dodge              | 30   | 30    |
| Fighting (Brawl)   | 25   | 25    |

---

## Equipment and Inventory

- Physician's bag (bandages, antiseptic, suture kit, scalpel, laudanum phial)
- Personal journal — leather-bound, half filled
- .32 revolver (carried since the dock incident — purchased before session 2)
- 6 rounds .32 ammunition
- Flask of brandy
- Letter of introduction from Boston Medical Society
- $135 remaining personal funds
...
## Condition Notes (post-session 2)

- Lost 3 SAN seeing [[Brother Ezra]]'s eyes at the docks
- Minor bruising, no HP loss
- Carrying the stone tablets in her medical bag (heavy)
