...
|-------|----------|-------------|
| `system` | `publish.system` | Game system identifier. Expected values: `coc-7e`, `coc-7e-regency`, `gurps-4e`, `dnd-5e-2024`, `pf2e`, `fitd`. Currently informational — system-specific rendering is a future roadmap item. |
